...
const PetrolPumpAllOrders: React.FC = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      const response = await fetch(`/api/ordersGet?agencyName=${agencyName}`);
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const ordersResponse = await fetch(
        `/api/ordersGet?agencyName=${formattedFormData.agencyName}`
      );
  ...
  return (
    <div className="p-6 bg-gray-50 rounded-3xl shadow-lg">
      <ToastContainer />
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full sm:w-96 md:w-4/6 lg:w-4/6 max-h-screen overflow-y-auto relative">
            ...
            <form onSubmit={handleFormSubmit}>
              {/* Loop through fields except pendingAmount */}
                ...
                {fields
                  ...
                  .map((field: any) => (
                    <div className="mb-4" key={field}>
                      <label
                        htmlFor={field}
                        className="block text-gray-700 capitalize text-sm sm:text-base"
                      >
                      ...
                      <input
                        ...
                        id={field}
                        name={field}
                        value={formData[field as keyof typeof formData]} // Bind the form data to input fields
                        onChange={handleInputChange} // Ensure the input change is handled
              ...
              {/* Group Pending Amount, Fuel Type, and Order Date in a Horizontal Row */}
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="w-80 bg-gray-700 text-white p-2 rounded-md hover:bg-gray-500"
                >
...
export default PetrolPumpAllOrders;
